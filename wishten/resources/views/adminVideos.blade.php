        ...
        <table id="filteredTable" class="userInfo">
            ...
            @foreach ($videos as $video)
                <tr>
                    ...
                    <td>
                        <form id="action-buttons" action="{{ route('video.delete', ['video' => $video->id, 'admin' => true]) }}" method="post">
                            @csrf
                            <a href="{{ route('video.watch', ['video'=>$video->id]) }}" class="button" type="button">Watch</a>
